...
procedure Tfrm108_Kanan.btn108RClick(Sender: TObject);
begin
  Hide;
end;

procedure Tfrm108_Kanan.btn1Click(Sender: TObject);
begin
   btlonch := not btlonch;
   SetChangeImageIndikator(imgSelLauncher,path_image_108 +'RedInd.bmp', path_image_108 +'OffInd.bmp', btlonch);
end;

procedure Tfrm108_Kanan.btn2Click(Sender: TObject);
begin
...
procedure Tfrm108_Kanan.btnBreakUNFR1Click(Sender: TObject);
begin
...
procedure Tfrm108_Kanan.btnBreakUNFR2Click(Sender: TObject);
begin
...
procedure Tfrm108_Kanan.btnModeClick(Sender: TObject);
begin
   btmode := not btmode;
...
procedure Tfrm108_Kanan.btnPOWERClick(Sender: TObject);
begin
...
procedure Tfrm108_Kanan.btnUNFORMER1_OffClick(Sender: TObject);
begin
   imgInd_UNFR1.Picture.LoadFromFile(path_image_108 + 'lampu indikator off.bmp');
end;

procedure Tfrm108_Kanan.btnUNFORMER1_OnClick(Sender: TObject);
begin
   imgInd_UNFR1.Picture.LoadFromFile(path_image_108 + 'lampu indikator on.bmp');
end;

procedure Tfrm108_Kanan.btnUNFORMER2_OffClick(Sender: TObject);
begin
   imgInd_UNFR2.Picture.LoadFromFile(path_image_108 + 'lampu indikator off.bmp');
end;

procedure Tfrm108_Kanan.btnUNFORMER2_OnClick(Sender: TObject);
begin
   imgInd_UNFR2.Picture.LoadFromFile(path_image_108 + 'lampu indikator on.bmp');
end;

procedure Tfrm108_Kanan.FormCreate(Sender: TObject);
begin
   btlonch   := False;
   btmode    := False;
   launcNumb := 1;
...
procedure Tfrm108_Kanan.FormShow(Sender: TObject);
begin
...
procedure Tfrm108_Kanan.imgModeClick(Sender: TObject);
begin
   ModeNumb := ModeNumb + 1;
...
procedure Tfrm108_Kanan.imgLauncNumbClick(Sender: TObject);
begin
