...
uses
  ...
  ImgList, Buttons, SpeedButtonImage;
...
//  LoadImageList;
  ...
  bmp := TBitmap.Create;
  bmp.LoadFromFile(image_path+ 'tdc\MIKSpaceButton.bmp');
  btn_space.Glyph.Assign(bmp);    //       := btn_Space.Glyph;
  bmp.Free;

  bmp := TBitmap.Create;
  bmp.LoadFromFile(image_path+ 'tdc\MIK4SpaceButton.bmp');
  btn_4space.Glyph.Assign(bmp);    //       := btn_Space.Glyph;
  bmp.Free;

  bmp := TBitmap.Create;
  bmp.LoadFromFile(image_path+ 'tdc\MIKBackSpaceButton.bmp');
  btn_Backspace.Glyph.Assign(bmp);  //    := btn_Space.Glyph;
  bmp.Free;


  bmp := TBitmap.Create;
  bmp.LoadFromFile(image_path+ 'tdc\MIKEraseLineButton.bmp');
  btn_EraseSpace.Glyph.Assign(bmp);  //   := btn_Space.Glyph;
  bmp.Free;

  bmp := TBitmap.Create;
  bmp.LoadFromFile(image_path+ 'tdc\Mik_Execute.bmp');
  btn_Execute.Glyph.Assign(bmp);  //   := btn_Space.Glyph;
  bmp.Free;
