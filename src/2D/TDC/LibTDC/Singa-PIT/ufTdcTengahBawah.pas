...
type
  TfrmTdcTengahBawah = class(TfrmQEK)
    ...
    procedure pnlCaptionMouseMove(Sender: TObject; Shift: TShiftState; X,
      Y: Integer);
  private
...
procedure TfrmTdcTengahBawah.setPosition(ParentForm:TForm);
begin
...
procedure TfrmTdcTengahBawah.setMaxPosition(ParentForm:TForm);
begin
...
procedure TfrmTdcTengahBawah.pnlCaptionMouseMove(Sender: TObject;
