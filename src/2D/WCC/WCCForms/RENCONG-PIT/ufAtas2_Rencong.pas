...
type
  TfrmAtas2_Rencong = class(TfrmQEK)
    Timer1: TTimer;
    Panel8: TPanel;
...
uses
  ufAtas_Rencong, ufBawah_Rencong, ufBawah2_Rencong, ufWCCTengah, uWCCManager, uTDCConstan;
...
procedure TfrmAtas2_Rencong.Timer1Timer(Sender: TObject);
var
  band: Integer;
begin
  //Inc(TIMER_COUNTER,1);
...
//      RADAR CONTROL PANEL                     //
//**********************************************//
procedure TfrmAtas2_Rencong.btnRadarRadiateClick(Sender: TObject);
begin
...
procedure TfrmAtas2_Rencong.btnRadarStandByClick(Sender: TObject);
begin
...
procedure TfrmAtas2_Rencong.btnRDRSILClick(Sender: TObject);
begin
...
procedure TfrmAtas2_Rencong.btnRadarAlarmClick(Sender: TObject);
var
  fA: TfrmAtas_Rencong;
  fB: TfrmBawah_Rencong;
  fB2: TfrmBawah2_Rencong;
begin
  ConsoleWCC.PowerON := True;
  ConsoleWCC.SystemON := True;
  ConsoleWCC.Radar.Status := RAD_STANDBY;
  TfrmAtas_Rencong(WCCInterface.frmWCCAtas1).IsProgLoaded := true;
  TfrmAtas_Rencong(WCCInterface.frmWCCAtas1).IsSysRDY := true;
  TfrmAtas_Rencong(WCCInterface.frmWCCAtas1).btnSystemOnClick(nil);
  BtnC.UpdateLockBtnImage(btnRadarAlarm, redBOX);
end;

procedure TfrmAtas2_Rencong.btnHORSCANClick(Sender: TObject);
begin
  if ConsoleWCC.PowerON and ConsoleWCC.SystemON then
  begin
    { TAMPILAN BTN }
    ...
    begin
      ...
      BtnC.UpdateImage(TfrmBawah_Rencong(WCCInterface.frmWCCBawah1).lmpHORSCAN, BtnC.greenROUND_On);
    end;
...
procedure TfrmAtas2_Rencong.btnHELSCANClick(Sender: TObject);
begin
  if ConsoleWCC.PowerON and ConsoleWCC.SystemON then
  begin
    { TAMPILAN BTN }
    ...
    begin
      ...
      BtnC.UpdateImage(TfrmBawah_Rencong(WCCInterface.frmWCCBawah1).lmpHORSCAN, BtnC.greenROUND_Off);
    end;
...
procedure TfrmAtas2_Rencong.btnHORPOLClick(Sender: TObject);
begin
  if ConsoleWCC.PowerON and ConsoleWCC.SystemON then
  begin
    { TAMPILAN BTN }
...
procedure TfrmAtas2_Rencong.btnCIRCPOLClick(Sender: TObject);
begin
  if ConsoleWCC.PowerON and ConsoleWCC.SystemON then
  begin
    { TAMPILAN BTN }
...
procedure TfrmAtas2_Rencong.btnLOWPRFClick(Sender: TObject);
begin
  if ConsoleWCC.PowerON and ConsoleWCC.SystemON then
  begin
    { TAMPILAN BTN }
...
procedure TfrmAtas2_Rencong.btnHIGHPRFClick(Sender: TObject);
begin
  if ConsoleWCC.PowerON and ConsoleWCC.SystemON then
  begin
    { TAMPILAN BTN }
...
procedure TfrmAtas2_Rencong.btnFREQ1Click(Sender: TObject);
var
...
procedure TfrmAtas2_Rencong.Reset_Freq_Button;
begin
...
procedure TfrmAtas2_Rencong.btnFREQAGILClick(Sender: TObject);
begin
  if ConsoleWCC.PowerON and ConsoleWCC.SystemON then
  begin
    { TAMPILAN BTN }
...
procedure TfrmAtas2_Rencong.btnFIXFREQClick(Sender: TObject);
begin
  if ConsoleWCC.PowerON and ConsoleWCC.SystemON then
  begin
    { TAMPILAN BTN }
...
procedure TfrmAtas2_Rencong.btnRDRSTABClick(Sender: TObject);
begin
  { TAMPILAN BTN }
  //UpdateLockBtnImage(btnRDRSTAB, redBOX);
end;

procedure TfrmAtas2_Rencong.btnAUTOFREQClick(Sender: TObject);
begin
  if ConsoleWCC.PowerON and ConsoleWCC.SystemON then
  begin
...
// Receiver //
procedure TfrmAtas2_Rencong.btnMTIPLDClick(Sender: TObject);
begin
  if ConsoleWCC.PowerON and ConsoleWCC.SystemON then
  begin
    { TAMPILAN BTN }
...
procedure TfrmAtas2_Rencong.btnMTICORRClick(Sender: TObject);
begin
  if ConsoleWCC.PowerON and ConsoleWCC.SystemON then
  begin
    { TAMPILAN BTN }
...
procedure TfrmAtas2_Rencong.btnLOGClick(Sender: TObject);
begin
  if ConsoleWCC.PowerON and ConsoleWCC.SystemON then
  begin
...
procedure TfrmAtas2_Rencong.btnLINClick(Sender: TObject);
begin
  if ConsoleWCC.PowerON and ConsoleWCC.SystemON then
  begin
...
procedure TfrmAtas2_Rencong.btnDICKEFIXClick(Sender: TObject);
begin
  if ConsoleWCC.PowerON and ConsoleWCC.SystemON then
  begin
...
procedure TfrmAtas2_Rencong.btnPLDClick(Sender: TObject);
begin
  if ConsoleWCC.PowerON and ConsoleWCC.SystemON then
  begin
...
procedure TfrmAtas2_Rencong.btnISUClick(Sender: TObject);
begin
  if ConsoleWCC.PowerON and ConsoleWCC.SystemON then
  begin
...
procedure TfrmAtas2_Rencong.btnQUATClick(Sender: TObject);
begin
  if ConsoleWCC.PowerON and ConsoleWCC.SystemON then
  begin
...
procedure TfrmAtas2_Rencong.btnSTCClick(Sender: TObject);
begin
  if ConsoleWCC.PowerON and ConsoleWCC.SystemON then
  begin
...
//**********************************************//
procedure TfrmAtas2_Rencong.btnG1SAVEClick(Sender: TObject);
begin
  if ConsoleWCC.PowerON and ConsoleWCC.SystemON then
  begin
...
procedure TfrmAtas2_Rencong.btnG1UNSAVEClick(Sender: TObject);
begin
  if ConsoleWCC.PowerON and ConsoleWCC.SystemON then
  begin
...
procedure TfrmAtas2_Rencong.btnG1PARPROXClick(Sender: TObject);
begin
  if ConsoleWCC.PowerON and ConsoleWCC.SystemON then
  begin
...
procedure TfrmAtas2_Rencong.btnG1AM1Click(Sender: TObject);
begin
  if ConsoleWCC.PowerON and ConsoleWCC.SystemON then
  begin
...
procedure TfrmAtas2_Rencong.btnG1AM2Click(Sender: TObject);
begin
  if ConsoleWCC.PowerON and ConsoleWCC.SystemON then
  begin
...
procedure TfrmAtas2_Rencong.btnG1SINGLEClick(Sender: TObject);
begin
  if ConsoleWCC.PowerON and ConsoleWCC.SystemON then
  begin
...
procedure TfrmAtas2_Rencong.btnG2ONClick(Sender: TObject);
begin
  if ConsoleWCC.PowerON and ConsoleWCC.SystemON then
  begin
    btnG2ON.Down := True;
...
procedure TfrmAtas2_Rencong.btnG2OFFClick(Sender: TObject);
begin
  if ConsoleWCC.PowerON and ConsoleWCC.SystemON then
  begin
    btnG2OFF.Down := True;
...
procedure TfrmAtas2_Rencong.btnG2PARPROXClick(Sender: TObject);
begin
  if ConsoleWCC.PowerON and ConsoleWCC.SystemON then
  begin
...
procedure TfrmAtas2_Rencong.btnG2HETRCRClick(Sender: TObject);
begin
  if ConsoleWCC.PowerON and ConsoleWCC.SystemON then
  begin
...
procedure TfrmAtas2_Rencong.btnG2PREFRAGClick(Sender: TObject);
begin
  if ConsoleWCC.PowerON and ConsoleWCC.SystemON then
  begin
...
//      SAKLAR PANEL ATAS                       //
//**********************************************//
procedure TfrmAtas2_Rencong.VL13Click(Sender: TObject);
begin
  ConsoleWCC.Saklar[TSpeedButtonImage(Sender).Tag] := TSpeedButtonImage(Sender).Down;
end;
procedure TfrmAtas2_Rencong.FormShow(Sender: TObject);
begin
