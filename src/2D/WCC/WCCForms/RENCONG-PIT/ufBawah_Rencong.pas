...
type
  TfrmBawah_Rencong = class(TfrmQEK)
    Timer1: TTimer;
    elevTimer: TTimer;
    Panel1: TPanel;
    lmpHORSCAN: TImage;
...
uses
  ufWCCTengah, ufBawah2_Rencong, uLibTDCClass, uTDCConstan, uLibTDCTracks;
...
//      FORM EVENTS                             //
//**********************************************//
procedure TfrmBawah_Rencong.FormCreate(Sender: TObject);
begin
  inherited;
...
//      RADAR PANEL                             //
//**********************************************//
procedure TfrmBawah_Rencong.spbSetRangeClick(Sender: TObject);
var
...
procedure TfrmBawah_Rencong.Reset_Scale_Button;
begin
...
procedure TfrmBawah_Rencong.btnIFFClick(Sender: TObject);
begin
...
procedure TfrmBawah_Rencong.btnRRClick(Sender: TObject);
begin
  if ConsoleWCC.PowerON and ConsoleWCC.SystemON and (ConsoleWCC.Radar.Status = RAD_RADIATE) then
  begin
...
procedure TfrmBawah_Rencong.btnHMClick(Sender: TObject);
begin
  if ConsoleWCC.PowerON and ConsoleWCC.SystemON and (ConsoleWCC.Radar.Status = RAD_RADIATE) then
  begin
...
procedure TfrmBawah_Rencong.VIDEOSELClick(Sender: TObject);
var
  Ob : TSpeedButtonImage;
  lbl: TLabel;
  tagg: byte;
...
procedure TfrmBawah_Rencong.Reset_Vid_Button;
begin
...
procedure TfrmBawah_Rencong.btnAIRClick(Sender: TObject);
begin
  if ConsoleWCC.PowerON and ConsoleWCC.SystemON then
  begin
...
procedure TfrmBawah_Rencong.btnSURFClick(Sender: TObject);
begin
  if ConsoleWCC.PowerON and ConsoleWCC.SystemON then
  begin
...
procedure TfrmBawah_Rencong.btnEWClick(Sender: TObject);
begin
  if ConsoleWCC.PowerON and ConsoleWCC.SystemON then
  begin
...
procedure TfrmBawah_Rencong.btnBLINDARCClick(Sender: TObject);
begin
  if ConsoleWCC.PowerON and ConsoleWCC.SystemON then
  begin
...
procedure TfrmBawah_Rencong.btnLPDTESTClick(Sender: TObject);
begin
  if ConsoleWCC.PowerON and ConsoleWCC.SystemON then
  begin
...
procedure TfrmBawah_Rencong.btnMSClick(Sender: TObject);
begin
  if ConsoleWCC.PowerON and ConsoleWCC.SystemON then
  begin
...
procedure TfrmBawah_Rencong.btnCOURSEClick(Sender: TObject);
begin
  if ConsoleWCC.PowerON and ConsoleWCC.SystemON then
  begin
...
procedure TfrmBawah_Rencong.btnAMPLINFOClick(Sender: TObject);
begin
  if ConsoleWCC.PowerON and ConsoleWCC.SystemON then
  begin
...
procedure TfrmBawah_Rencong.btnLINKClick(Sender: TObject);
begin
  if ConsoleWCC.PowerON and ConsoleWCC.SystemON then
  begin
...
procedure TfrmBawah_Rencong.btnTNClick(Sender: TObject);
begin
  if ConsoleWCC.PowerON and ConsoleWCC.SystemON then
  begin
...
procedure TfrmBawah_Rencong.btnTMClick(Sender: TObject);
begin
  if ConsoleWCC.PowerON and ConsoleWCC.SystemON and (ConsoleWCC.Radar.Status = RAD_RADIATE) then
  begin
...
procedure TfrmBawah_Rencong.btnOFFCentClick(Sender: TObject);
begin
  if ConsoleWCC.PowerON and ConsoleWCC.SystemON and (ConsoleWCC.Radar.Status = RAD_RADIATE) then
  begin
...
procedure TfrmBawah_Rencong.btnCENTClick(Sender: TObject);
begin
  if ConsoleWCC.PowerON and ConsoleWCC.SystemON and (ConsoleWCC.Radar.Status = RAD_RADIATE) then
  begin
...
procedure TfrmBawah_Rencong.btnRESOBM_LEFTClick(Sender: TObject);
begin
...
procedure TfrmBawah_Rencong.btnRANGEMANClick(Sender: TObject);
begin
...
procedure TfrmBawah_Rencong.btnELEVMANClick(Sender: TObject);
begin
...
procedure TfrmBawah_Rencong.btnLOWFGTClick(Sender: TObject);
begin
...
procedure TfrmBawah_Rencong.btnPDTClick(Sender: TObject);
begin
  if ConsoleWCC.PowerON and ConsoleWCC.SystemON then
  begin
...
procedure TfrmBawah_Rencong.btnPATClick(Sender: TObject);
begin
  if ConsoleWCC.PowerON and ConsoleWCC.SystemON then
  begin
    if TSpeedButtonImage(Sender).Down then
...
procedure TfrmBawah_Rencong.btnATTCKRClick(Sender: TObject);
begin
  if ConsoleWCC.PowerON and ConsoleWCC.SystemON then
  begin
    if TSpeedButtonImage(Sender).Down then
...
procedure TfrmBawah_Rencong.btnSTANDOFFClick(Sender: TObject);
begin
  if ConsoleWCC.PowerON and ConsoleWCC.SystemON then
  begin
    if TSpeedButtonImage(Sender).Down then
...
procedure TfrmBawah_Rencong.btnATOClick(Sender: TObject);
begin
  if ConsoleWCC.PowerON and ConsoleWCC.SystemON then
  begin
...
procedure TfrmBawah_Rencong.btnAFAClick(Sender: TObject);
begin
...
procedure TfrmBawah_Rencong.btnSBAClick(Sender: TObject);
begin
  if ConsoleWCC.PowerON and ConsoleWCC.SystemON then
  begin
...
procedure TfrmBawah_Rencong.btnGENClick(Sender: TObject);
begin
...
procedure TfrmBawah_Rencong.btnG1ATTN_AClick(Sender: TObject);
begin
...
procedure TfrmBawah_Rencong.btnG1FIRE_AClick(Sender: TObject);
begin
  BtnC.SpringLoaded(TSpeedButtonImage(Sender)); 
end;

procedure TfrmBawah_Rencong.btnG2ATTN_AClick(Sender: TObject);
begin
...
procedure TfrmBawah_Rencong.btnG2FIRE_AClick(Sender: TObject);
begin
  BtnC.SpringLoaded(TSpeedButtonImage(Sender)); 
end;

procedure TfrmBawah_Rencong.Timer1Timer(Sender: TObject);
begin
...
procedure TfrmBawah_Rencong.elevTimerTimer(Sender: TObject);
begin
  wBearing.Position := wBearing.Position + 1;
  wBearingChange(nil);
end;

procedure TfrmBawah_Rencong.FormShow(Sender: TObject);
begin
  self.Timer1.Enabled := True;
end;

procedure TfrmBawah_Rencong.wBearingChange(Sender: TObject);
begin
...
procedure TfrmBawah_Rencong.wBearingMouseDown(Sender: TObject;
