...
uses
  ...
  uBaseConstan, uTCPDatatype, uBaseDataType, uBaseFunction, uDetected,
  ufQEK;

type
  TfrmBawah2_Rencong = class(TfrmQEK)
    Panel6: TPanel;
    Bevel22: TBevel;
    Bevel13: TBevel;
    Bevel17: TBevel;
    ...
    Shape8: TShape;
    btnG1FIRE: TSpeedButtonImage;
    btnG2ATTNFC2: TSpeedButtonImage;
    Shape9: TShape;
    btnG2FIRE: TSpeedButtonImage;
    Label31: TLabel;
    Label35: TLabel;
    Label43: TLabel;
    Label44: TLabel;
...
uses
  ufWCCTengah, ufBawah_Rencong, uLabelDisplay, Types, Math, uLibTDCTracks, uTDCConstan;
...
procedure TfrmBawah2_Rencong.FormCreate(Sender: TObject);
begin
  inherited;
...
function TfrmBawah2_Rencong.SplitPage(const s: string): integer;
begin
  result := StrToInt(Copy(s, 0, 1));
end;

function TfrmBawah2_Rencong.SplitEditName(const s: string): string;
begin
  result := Copy(s, 5, Length(s) - 1);
end;

function TfrmBawah2_Rencong.GetLine(const aCode: string): string;
var tCode: string;
    i: integer;
begin
  result := '';
...
function TfrmBawah2_Rencong.GetValue(const aCode: string): string;
var nm  : string;
    i   : integer;
    tbox: TEdit;
begin
...
function TfrmBawah2_Rencong.ValidateCode(const aCode: string): boolean;
var i: integer;
begin
  result := false;
...
function TfrmBawah2_Rencong.ValidateValue(const aCode, aVal: string): boolean;
var val: single;
    cod : integer;
    //part1, part2: string;
...
function TfrmBawah2_Rencong.CekOnOff(const aCode: string): boolean;
begin
  if (aCode = 'ON') or (aCode = 'OFF') then result := true
  else result := false;
end;

procedure TfrmBawah2_Rencong.InsertIntoAndu(const code: string; const val: double);
begin
...
//ANDU
procedure TfrmBawah2_Rencong.PreActShow;
begin
...
procedure TfrmBawah2_Rencong.AirSurfShow ;
begin
  tvpage.Visible :=false;
...
procedure TfrmBawah2_Rencong.TestPageShow;
begin
  tvpage.Visible :=false;
  airsurfpage.Visible :=false;
  ngspage.Visible :=false;
...
procedure TfrmBawah2_Rencong.NgsShow;
begin
  tvpage.Visible :=false;
  airsurfpage.Visible :=false;
...
procedure TfrmBawah2_Rencong.tvshow ;
begin
  tvpage.Visible :=true;
  airsurfpage.Visible :=false;
  ngspage.Visible :=false;
...
procedure TfrmBawah2_Rencong.getcode;
var page : integer;
...
procedure TfrmBawah2_Rencong.ApplyNumber(text: string);
begin
...
procedure TfrmBawah2_Rencong.ShowAnduData;
begin
  ...
  // TOF
  Andu2091.Text := WCCInterface.WCCAndu.Page_2[C_TOF][1].ToFlooredString;
  Andu2092.Text := WCCInterface.WCCAndu.Page_2[C_TOF][2].ToFlooredString;
  //Andu2093.Text := WCCInterface.WCCAndu.Page_2[C_TOF][3].ToFlooredString;
...
//      ASSIGNMENT PANEL                        //
//**********************************************//
procedure TfrmBawah2_Rencong.btnG1FC1ASSClick(Sender: TObject);
var fB: TfrmBawah_Rencong;
begin
  BtnC.SpringLoaded(TSpeedButtonImage(Sender));

  if ConsoleWCC.PowerON and ConsoleWCC.SystemON then
  begin
    fB := TfrmBawah_Rencong(WCCInterface.frmWCCBawah1);
...
procedure TfrmBawah2_Rencong.btnG2FC1ASSClick(Sender: TObject);
var fB: TfrmBawah_Rencong;
begin
  BtnC.SpringLoaded(TSpeedButtonImage(Sender));
...
procedure TfrmBawah2_Rencong.btnTVFC1Click(Sender: TObject);
begin
  //BtnC.SpringLoaded(TSpeedButtonImage(Sender));
...
procedure TfrmBawah2_Rencong.btnG1FC2ASSClick(Sender: TObject);
begin
  BtnC.SpringLoaded(TSpeedButtonImage(Sender));
...
procedure TfrmBawah2_Rencong.btnG2FC2ASSClick(Sender: TObject);
begin
  BtnC.SpringLoaded(TSpeedButtonImage(Sender));
...
procedure TfrmBawah2_Rencong.btnTVFC2Click(Sender: TObject);
begin
  BtnC.SpringLoaded(TSpeedButtonImage(Sender));
...
procedure TfrmBawah2_Rencong.btnG1FC3ASSClick(Sender: TObject);
begin
  BtnC.SpringLoaded(TSpeedButtonImage(Sender));
...
procedure TfrmBawah2_Rencong.btnG2FC3ASSClick(Sender: TObject);
begin
  BtnC.SpringLoaded(TSpeedButtonImage(Sender));
...
procedure TfrmBawah2_Rencong.btnTVFC3Click(Sender: TObject);
begin
  BtnC.SpringLoaded(TSpeedButtonImage(Sender));
...
{procedure TfrmBawah2_Rencong.Reset_AssignGun2FC4;
begin
  ...
  BtnC.UpdateBtnImage(btnG3FC4ASS, BtnC.greenBOX_Off);
end;}

procedure TfrmBawah2_Rencong.btnG1FC4ASSClick(Sender: TObject);
begin
  BtnC.SpringLoaded(TSpeedButtonImage(Sender));
  //BtnC.UpdateLockBtnImage(TSpeedButtonImage(Sender), greenBOX);
  if ConsoleWCC.PowerON and ConsoleWCC.SystemON then
...
procedure TfrmBawah2_Rencong.btnG2FC4ASSClick(Sender: TObject);
begin
  BtnC.SpringLoaded(TSpeedButtonImage(Sender));
  //BtnC.UpdateLockBtnImage(TSpeedButtonImage(Sender), greenBOX);
  if ConsoleWCC.PowerON and ConsoleWCC.SystemON then
...
procedure TfrmBawah2_Rencong.btnTVFC4Click(Sender: TObject);
begin
  BtnC.SpringLoaded(TSpeedButtonImage(Sender));
...
procedure TfrmBawah2_Rencong.btnFC2SBSClick(Sender: TObject);
begin
  if ConsoleWCC.PowerON and ConsoleWCC.SystemON then
  begin
...
procedure TfrmBawah2_Rencong.btnFC3SBSClick(Sender: TObject);
begin
  if ConsoleWCC.PowerON and ConsoleWCC.SystemON then
  begin
...
procedure TfrmBawah2_Rencong.btnFC2STOClick(Sender: TObject);
begin
...
procedure TfrmBawah2_Rencong.btnFC3STOClick(Sender: TObject);
begin
...
procedure TfrmBawah2_Rencong.btnFC2AFSClick(Sender: TObject);
begin
  BtnC.SpringLoaded(TSpeedButtonImage(Sender));
end;

procedure TfrmBawah2_Rencong.btnFC3AFSClick(Sender: TObject);
begin
  BtnC.SpringLoaded(TSpeedButtonImage(Sender));
end;

procedure TfrmBawah2_Rencong.btnG1ATTNFC2Click(Sender: TObject);
begin
  BtnC.SpringLoaded(TSpeedButtonImage(Sender));
end;

procedure TfrmBawah2_Rencong.btnG1FIREClick(Sender: TObject);
begin
  BtnC.SpringLoaded(TSpeedButtonImage(Sender));
end;

procedure TfrmBawah2_Rencong.btnG2ATTNFC2Click(Sender: TObject);
begin
  BtnC.SpringLoaded(TSpeedButtonImage(Sender));
end;

procedure TfrmBawah2_Rencong.btnG2FIREClick(Sender: TObject);
begin
  BtnC.SpringLoaded(TSpeedButtonImage(Sender));
end;

procedure TfrmBawah2_Rencong.btnG1ATTNFC3Click(Sender: TObject);
begin
  BtnC.SpringLoaded(TSpeedButtonImage(Sender));
end;

procedure TfrmBawah2_Rencong.btnG2ATTNFC3Click(Sender: TObject);
begin
  BtnC.SpringLoaded(TSpeedButtonImage(Sender));
end;

procedure TfrmBawah2_Rencong.btnSplashCorrClick(Sender: TObject);
begin
  if ConsoleWCC.PowerON and ConsoleWCC.SystemON then
  begin
...
procedure TfrmBawah2_Rencong.SpeedButtonImage92Click(Sender: TObject);
begin
  BtnC.SpringLoaded(TSpeedButtonImage(Sender));
end;

procedure TfrmBawah2_Rencong.btnRESOBM_RIGHTClick(Sender: TObject);
begin
...
//**********************************************//  
procedure TfrmBawah2_Rencong.btnBLINDBOMBClick(Sender: TObject);
...
procedure TfrmBawah2_Rencong.btnINDBOMBClick(Sender: TObject);
var b, r: double;
begin
  BtnC.SpringLoaded(TSpeedButtonImage(Sender));
  if ConsoleWCC.PowerON and ConsoleWCC.SystemON then
...
procedure TfrmBawah2_Rencong.btnGENFC2Click(Sender: TObject);
begin
  BtnC.SpringLoaded(TSpeedButtonImage(Sender));
  if ConsoleWCC.PowerON and ConsoleWCC.SystemON then
  begin
...
procedure TfrmBawah2_Rencong.btnGENFC3Click(Sender: TObject);
begin
  BtnC.SpringLoaded(TSpeedButtonImage(Sender));
  if ConsoleWCC.PowerON and ConsoleWCC.SystemON then
  begin
...
procedure TfrmBawah2_Rencong.btnFC2_BClick(Sender: TObject);
begin
  if ConsoleWCC.PowerON and ConsoleWCC.SystemON then
  begin
...
procedure TfrmBawah2_Rencong.btnFC3_BClick(Sender: TObject);
begin
  if ConsoleWCC.PowerON and ConsoleWCC.SystemON then
  begin
...
//      ACTION PAGE                             //
//**********************************************//
procedure TfrmBawah2_Rencong.Reset_Andu_Button;
begin
...
procedure TfrmBawah2_Rencong.btnPREACTClick(Sender: TObject);
begin
  //BtnC.SpringLoaded(TSpeedButtonImage(Sender));
...
procedure TfrmBawah2_Rencong.btnAIRSURFClick(Sender: TObject);
begin
  if ConsoleWCC.PowerON and ConsoleWCC.SystemON then begin
  //BtnC.SpringLoaded(TSpeedButtonImage(Sender));
  self.Reset_Andu_Button;
...
procedure TfrmBawah2_Rencong.btnNGSClick(Sender: TObject);
begin
  if ConsoleWCC.PowerON and ConsoleWCC.SystemON then begin
  //BtnC.SpringLoaded(TSpeedButtonImage(Sender));
  self.Reset_Andu_Button;
...
procedure TfrmBawah2_Rencong.btnTESTClick(Sender: TObject);
begin
  if ConsoleWCC.PowerON and ConsoleWCC.SystemON then begin
  //BtnC.SpringLoaded(TSpeedButtonImage(Sender));
  self.Reset_Andu_Button;
...
procedure TfrmBawah2_Rencong.btnTVClick(Sender: TObject);
begin
  if ConsoleWCC.PowerON and ConsoleWCC.SystemON then begin
    self.Reset_Andu_Button;
...
procedure TfrmBawah2_Rencong.Timer1Timer(Sender: TObject);
begin
  ...
  BtnC.UpdateBtnImage(btnG1FIRE, GreenBOX, WCCInterface.Gun1.ReadyToFire and (WCCInterface.Gun1.AssignTo <> nil) and (WCCInterface.Gun1.AssignTo.Name <> 'FC1'));
  BtnC.UpdateBtnImage(btnG2FIRE, GreenBOX, WCCInterface.Gun2.ReadyToFire and (WCCInterface.Gun2.AssignTo <> nil) and (WCCInterface.Gun2.AssignTo.Name <> 'FC1'));
...
procedure TfrmBawah2_Rencong.bteraseClick(Sender: TObject);
begin
  CodeInput.Text :='';
...
procedure TfrmBawah2_Rencong.bt0Click(Sender: TObject);
begin
  if ConsoleWCC.PowerON and ConsoleWCC.SystemON then
    applynumber('0');
end;

procedure TfrmBawah2_Rencong.bt1Click(Sender: TObject);
begin
  if ConsoleWCC.PowerON and ConsoleWCC.SystemON then
    applynumber('1');
end;

procedure TfrmBawah2_Rencong.bt2Click(Sender: TObject);
begin
  if ConsoleWCC.PowerON and ConsoleWCC.SystemON then
    applynumber('2');
end;

procedure TfrmBawah2_Rencong.bt3Click(Sender: TObject);
begin
  if ConsoleWCC.PowerON and ConsoleWCC.SystemON then
    applynumber('3');
end;

procedure TfrmBawah2_Rencong.bt4Click(Sender: TObject);
begin
  if ConsoleWCC.PowerON and ConsoleWCC.SystemON then
    applynumber('4');
end;

procedure TfrmBawah2_Rencong.bt5Click(Sender: TObject);
begin
  if ConsoleWCC.PowerON and ConsoleWCC.SystemON then
    applynumber('5');
end;

procedure TfrmBawah2_Rencong.bt6Click(Sender: TObject);
begin
  if ConsoleWCC.PowerON and ConsoleWCC.SystemON then
    applynumber('6');
end;

procedure TfrmBawah2_Rencong.bt7Click(Sender: TObject);
begin
  if ConsoleWCC.PowerON and ConsoleWCC.SystemON then
    applynumber('7');
end;

procedure TfrmBawah2_Rencong.bt8Click(Sender: TObject);
begin
  if ConsoleWCC.PowerON and ConsoleWCC.SystemON then
    applynumber('8');
end;

procedure TfrmBawah2_Rencong.bt9Click(Sender: TObject);
begin
  if ConsoleWCC.PowerON and ConsoleWCC.SystemON then
    applynumber('9');
end;

procedure TfrmBawah2_Rencong.btplusClick(Sender: TObject);
begin
  if ConsoleWCC.PowerON and ConsoleWCC.SystemON then
    applynumber('+');
end;

procedure TfrmBawah2_Rencong.btminClick(Sender: TObject);
begin
  if ConsoleWCC.PowerON and ConsoleWCC.SystemON then
    applynumber('-');
end;

procedure TfrmBawah2_Rencong.btinsertClick(Sender: TObject);
begin
  if ConsoleWCC.PowerON and ConsoleWCC.SystemON then
...
procedure TfrmBawah2_Rencong.insertvalue ;
var i :integer;
...
procedure TfrmBawah2_Rencong.vThrowOffChange(Sender: TObject);
begin
  if ConsoleWCC.PowerON and ConsoleWCC.SystemON then
  begin
    if WCCInterface.IsFireControlInUse(2) then begin
...
procedure TfrmBawah2_Rencong.tmrGunTimer(Sender: TObject);
