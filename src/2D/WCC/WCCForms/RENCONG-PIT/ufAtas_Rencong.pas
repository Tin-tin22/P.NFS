...
type
  TfrmAtas_Rencong = class(TfrmQEK)
    Timer1: TTimer;
    Panel4: TPanel;
...
uses ufAtas2_Rencong, ufBawah_Rencong, ufBawah2_Rencong;
...
//      FORM EVENTS                             //
//**********************************************//
procedure TfrmAtas_Rencong.FormCreate(Sender: TObject);
begin
...
procedure TfrmAtas_Rencong.Timer1Timer(Sender: TObject);
begin
  //Inc(TIMER_COUNTER,1);
  ...
  if IsMagRDY and IsProgLoaded and (ConsoleWCC.Radar.Status = RAD_OFF) then
    ...
    begin
      BtnC.UpdateBtnImage(TfrmAtas2_Rencong(self.WCCInterface.frmWCCAtas2).btnRadarStandBy, BtnC.greenBOX_On);
      IsSysRDY := True;
...
procedure TfrmAtas_Rencong.KondisiOff;
begin
...
procedure TfrmAtas_Rencong.VL1Click(Sender: TObject);
begin
...
procedure TfrmAtas_Rencong.btnSoftErrorClick(Sender: TObject);
begin
  Self.btnSoftError.Down := not Self.btnSoftError.Down;
end;

procedure TfrmAtas_Rencong.btnCompErrorClick(Sender: TObject);
begin
  Self.btnCompError.Down := not Self.btnCompError.Down;
end;

procedure TfrmAtas_Rencong.btnDisplayErrorClick(Sender: TObject);
begin
  Self.btnDisplayError.Down := not Self.btnDisplayError.Down;
end;

procedure TfrmAtas_Rencong.btnStabErrorClick(Sender: TObject);
begin
...
//**********************************************//
procedure TfrmAtas_Rencong.btnNAVClick(Sender: TObject);
begin
...
procedure TfrmAtas_Rencong.btnNOCASClick(Sender: TObject);
begin
  if ConsoleWCC.PowerON then
  begin
    { TAMPILAN BTN }
...
procedure TfrmAtas_Rencong.btnRELATIVEClick(Sender: TObject);
begin
  if ConsoleWCC.PowerON then
  begin
    { TAMPILAN BTN }
...
procedure TfrmAtas_Rencong.btnLINEUPClick(Sender: TObject);
begin
  if ConsoleWCC.PowerON then
  begin
    { TAMPILAN BTN }
...
procedure TfrmAtas_Rencong.btnPowerOffClick(Sender: TObject);
begin
  { TAMPILAN BTN }
...
procedure TfrmAtas_Rencong.btnPowerOnClick(Sender: TObject);
begin
...
procedure TfrmAtas_Rencong.btnLPClick(Sender: TObject);
begin
  btnLP.Down := True;
...
procedure TfrmAtas_Rencong.btnSystemOnClick(Sender: TObject);
var
  fA2: TfrmAtas2_Rencong;
  fB: TfrmBawah_Rencong;
  fB2: TfrmBawah2_Rencong;
begin
  if ConsoleWCC.PowerON and IsProgLoaded and IsSysRDY then
  begin
    fA2 := TfrmAtas2_Rencong(WCCInterface.frmWCCAtas2);
    fB := TfrmBawah_Rencong(WCCInterface.frmWCCBawah1);
    fB2 := TfrmBawah2_Rencong(WCCInterface.frmWCCBawah2);
...
procedure TfrmAtas_Rencong.btnSystemResetClick(Sender: TObject);
var b: Boolean;
begin
...
procedure TfrmAtas_Rencong.btnANTIICEClick(Sender: TObject);
begin
  if ConsoleWCC.PowerON then
  begin
     { TAMPILAN BTN }
...
procedure TfrmAtas_Rencong.btnSIMClick(Sender: TObject);
begin
  //SpringLoaded(btnSIM);
...
//**********************************************//
procedure TfrmAtas_Rencong.btnExtCompassClick(Sender: TObject);
begin
...
procedure TfrmAtas_Rencong.btnIntCompassClick(Sender: TObject);
begin
...
procedure TfrmAtas_Rencong.btnGyroOnOffClick(Sender: TObject);
begin
  if ConsoleWCC.PowerON and ConsoleWCC.SystemON then
  begin
...
procedure TfrmAtas_Rencong.FormShow(Sender: TObject);
begin
