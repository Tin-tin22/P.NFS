...
uses
  ...
  ufTDC1Kiri, ufTDC1Kanan, uSpecialForm, ClipBrd;
...
procedure TfMainTDC.mnOpenScenarioClick(Sender: TObject);
begin
...
procedure TfMainTDC.mnCloseSceneClick(Sender: TObject);
begin
...
begin
  uTOCOSManager.TOCOSsimCenter.TheTDC.frmKiri.Show;
end;

procedure TfMainTDC.mnDC1kanan1Click(Sender: TObject);
begin
  uTOCOSManager.TOCOSsimCenter.TheTDC.frmKanan.Show;
end;

procedure TfMainTDC.mnDC1KeyboardKiri1Click(Sender: TObject);
begin
  uTOCOSManager.TOCOSsimCenter.TheTDC.frmKeyboardKiri.Show;
end;

procedure TfMainTDC.mnDC1KeyboardKanan1Click(Sender: TObject);
begin
  uTOCOSManager.TOCOSsimCenter.TheTDC.frmKeyBoardKanan.Show;
end;
