...
uses
  ...
  Dialogs, VrControls, VrRotarySwitch, ExtCtrls, VrBlinkLed, Buttons,
  SpeedButtonImage, StdCtrls, ImgList;

type
  TfrmTdcPc = class(TForm)
...
procedure TfrmTdcPc.FormCreate(Sender: TObject);
var bmpnya : TBitmap;
begin
