...
// Date           : $Date: 2008/05/28 07:56:55 $
//
// Notes          : 
//
// Modifications  :
//
// $Log: SocketServer.h,v $
// Revision 1.4  2008/05/28 07:56:55  cvsuser
// nambah OnConnectionDropped
//
// Revision 1.3  2008/05/26 07:40:23  cvsuser
// ganti komponen network, menghapus file SimServerManager, nambah file SocketComponent, SocketServerGM, SocketCLientGM, merubah AppEntryPoint, SimServerMessage, SimClientMessageProc, dan lain-lain yang berhubungan dengan dtNetGM
//
// Revision 1.2  2008/04/01 03:34:15  cvsuser
// Sam.UpdateCVS
//
// Revision 1.1  2007/09/05 07:05:09  cvsuser
// New Update
//
// 
   ...
   protected CIOBuffer::Allocator
{
   public:
	  ...
	  void StartAcceptingConnections(unsigned long addressToListenOn);
   ...
   protected CSocketServer::ServerData
{
   public :
      ...
      bool IsConnected(
	    ...
	    // penambahan property untuk buffer
	    /*
      void setFBufferSizeKnown(bool aFBufferSizeKnown){FBufferSizeKnown= aFBufferSizeKnown;};
	    void setFBufferSize(unsigned int aFBufferSize){FBufferSize= aFBufferSize;};
	    void setFBufferSizeNow(unsigned int aFBufferSizeNow){FBufferSizeNow= aFBufferSizeNow;};
	    void setFBuffer(char *aFBuffer){FBuffer= aFBuffer;};

      bool getFBufferSizeKnown(){return FBufferSizeKnown;};
      unsigned int getFBufferSize(){return FBufferSize;};
	    unsigned int getFBufferSizeNow(){return FBufferSizeNow;};
	    char *getFBuffer(){return FBuffer;};
      */
      bool FBufferSizeKnown;
      unsigned int FBufferSize;
	    unsigned int FBufferNow;
	    char *FBuffer;
