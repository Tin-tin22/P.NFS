...
inline std::string GetCameraDOFName( const int WID , const int LID )  
{
	...
	//else if ( WID == CT_C802)			sname = C_CN_C802;
	//else 
	if ( WID == CT_CANNON_120)			sname =	"DOF_TDS1";	//C_DOF_NAME_CAMERA_CANNON120_1;
	else if ( WID == CT_CANNON_76)		sname =	"DOF_TDS1";	//C_DOF_NAME_CAMERA_CANNON76_1;
	else if ( WID == CT_CANNON_57)		sname =	"DOF_TDS1"; //C_DOF_NAME_CAMERA_CANNON57_1;
	else if ( WID == CT_CANNON_40)		sname =	"DOF_TDS1";	//C_DOF_NAME_CAMERA_CANNON40_1;
