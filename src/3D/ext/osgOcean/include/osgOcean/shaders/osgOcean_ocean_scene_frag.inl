...
static const char osgOcean_ocean_scene_frag[] =
    ...
    "uniform bool osgOcean_EnableGlow; //BAWE-20110805: GLOW_SHADER\n"
	...
	"\n"
    "const float glowAlphaValue = 0.5; //BAWE-20110805: The alpha value that indicates glowing\n"
    "\n"
	...
	"{\n"
	"    vec4 final_color;\n"
    "    bool isGlowing=false; // BAWE-20110805: GLOW_SHADER" 
	"\n"
	"    vec4 textureColor = texture2D( uTextureMap, gl_TexCoord[0].st );\n"
	"\n"
    "    //++ BAWE-20110805: GLOW_SHADER\n"
    "    if ( textureColor.a < 0.51 && textureColor.a > 0.49 )\n"
    "    {\n"
    "        isGlowing = true;\n"
    //"        gl_FragData[0] = vec4(textureColor.rgb, 1.0);\n"
    "    }\n"
    "\n"
    ...
    "        if ( isGlowing )\n"
    "        {\n"
    "           gl_FragData[0] = vec4(textureColor.rgb, 0.7);\n"
    "        }\n"
	"        else\n"
    "        //-- BAWE-20110805: GLOW_SHADER\n"
	"        // color buffer\n"
